...
namespace PontoAll_2810.Controllers
{
    public class ColaboradoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CPF,Email,Celular,Matricula,DataCadastro,Admissao,Senha,Matricula,Cargo,Salario,Desligamento")] Colaborador Colaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CPF,Email,Celular,Matricula,DataCadastro,Admissao,Senha,Matricula,Cargo,Salario,Desligamento")] Colaborador Colaborador)
        {
